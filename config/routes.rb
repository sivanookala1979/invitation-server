InvtappServer::Application.routes.draw do
  ...
  resources :public_events do
    ...
    get :remove_favourite_event, :on => :collection
    get :add_views, :on => :collection
    get :my_city_favourites, :on => :collection
    get :free_public_events, :on => :collection
  ...
  resources :events do
    ...
    post :check_contacts, :on => :collection
    get :differentiate_invitees, :on => :collection
  end
  ...
  resources :users do
    ...
    get :get_my_settings, :on => :collection
    post :update_my_settings, :on => :collection
  end
